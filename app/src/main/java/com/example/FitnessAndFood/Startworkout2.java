...
public class Startworkout2 extends AppCompatActivity {
   // private static final long START_TIME_IN_MILLIS = 21000;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        repeat.setText("Squats");
        gif.setImageResource(R.drawable.squats);
    ...
    public void showDialog(){
        ...
        btnQuit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                stopTimer();
                countup.stop(); //added
                Intent i = new Intent(Startworkout2.this, MainActivity.class);
                startActivity(i);
            }
        });

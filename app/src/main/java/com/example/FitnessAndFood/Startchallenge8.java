...
public class Startchallenge8 extends AppCompatActivity {
   // private static final long START_TIME_IN_MILLIS = 21000;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        repeat.setText("Wall Sit");
        gif.setImageResource(R.drawable.wallsit);
    ...
    private void startTimer(long START_TIME_IN_MILLIS) {
        ...
        mCountDownTimer = new CountDownTimer(mTimeLeftInMillis, 1000) {
            ...
            public void onFinish() {
                ...
                btnStartPause.setText("pause"); //resume
                btnNext.setVisibility(View.VISIBLE);
                btnNext.setClickable(true); //next button available after workout times up
    ...
    public void showDialog(){
        ...
        btnQuit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                stopTimer();
                countup.stop(); //added
                Intent i = new Intent(Startchallenge8.this, MainActivity.class);
                startActivity(i);
            }
        });

...
public class ChallengeAdv1 extends AppCompatActivity {
    RecyclerView recyclerView;
    Button start;
    ImageView img;
    TextView title,desc;
    final static int START_CHALLENGE7=1;
   ...
   //subworkout for recycler view
    public void challengeList(){
        ...
        extraDescList.add(getString(R.string.challengeAdv1_8));
        extraDescList.add(getString(R.string.challengeAdv1_9));
    ...
    public void onClick_start(View view) {
        Intent intent = new Intent(this, Startchallenge7.class);
        startActivityForResult(intent,START_CHALLENGE7);

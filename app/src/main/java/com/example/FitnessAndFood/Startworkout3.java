...
public class Startworkout3 extends AppCompatActivity {
    ...
    public void showDialog(){
        ...
        btnQuit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                countup.stop(); //added
                stopTimer();
                Intent i = new Intent(Startworkout3.this, MainActivity.class);
                startActivity(i);
            }
        });

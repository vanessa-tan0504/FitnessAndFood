...
public class Challenge2RVAdapter extends RecyclerView.Adapter<Challenge2RVAdapter.ViewHolder> {
    ...
    public Challenge2RVAdapter(Context context,
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        Challenge2RVAdapter.ViewHolder vh = new Challenge2RVAdapter.ViewHolder(v);
    ...
    //onclick to another  activity for challenge
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                switch(position){
                    case 0:
                        intent = new Intent(context, ChallengeInter1.class); //intermediate1
                        context.startActivity(intent);
                        break;
                    case 1:
                        intent = new Intent(context, ChallengeInter2.class); //intermediate2
                        context.startActivity(intent);
                        break;
                    case 2:
                        intent = new Intent(context, ChallengeInter3.class); //intermediate3
                        context.startActivity(intent);
                        break;

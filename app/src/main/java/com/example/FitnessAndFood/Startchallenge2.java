...
public class Startchallenge2 extends AppCompatActivity {
    ...
    public void showDialog(){
        ...
        btnQuit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                stopTimer();
                countup.stop(); //added
                Intent i = new Intent(Startchallenge2.this, MainActivity.class);
                startActivity(i);
            }
        });

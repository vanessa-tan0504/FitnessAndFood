...
public class ChallengeInter3 extends AppCompatActivity {
    RecyclerView recyclerView;
    Button start;
    ImageView img;
    TextView title,desc;
    final static int START_CHALLENGE6=1;
   ...
   //subworkout for recycler view
    ...
    public void onClick_start(View view) {
        Intent intent = new Intent(this, Startchallenge6.class);
        startActivityForResult(intent,START_CHALLENGE6);

...
public class ChallengeInter2 extends AppCompatActivity {
    RecyclerView recyclerView;
    Button start;
    ImageView img;
    TextView title,desc;
    final static int START_CHALLENGE5=1;
   ...
   //subworkout for recycler view
    ...
    public void onClick_start(View view) {
        Intent intent = new Intent(this, Startchallenge5.class);
        startActivityForResult(intent,START_CHALLENGE5);

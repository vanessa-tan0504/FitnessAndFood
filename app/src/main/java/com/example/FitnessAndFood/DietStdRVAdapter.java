...
public class DietStdRVAdapter extends RecyclerView.Adapter<DietStdRVAdapter.ViewHolder> {
    ...
    public DietStdRVAdapter(Context context,
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        DietStdRVAdapter.ViewHolder vh = new DietStdRVAdapter.ViewHolder(v);
